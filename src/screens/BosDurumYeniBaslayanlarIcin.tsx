...
export function BosDurumYeniBaslayanlarIcin({ onAddHabit, error, onClearError }: BosDurumYeniBaslayanlarIcinProps) {
  return (
    <>
      ...
      <button type="button" data-smoke-ignore aria-label="Hesap" className="p-2 rounded-full hover:bg-teal-100/50 dark:hover:bg-slate-800 transition-colors text-slate-500 dark:text-slate-400 cursor-pointer">
